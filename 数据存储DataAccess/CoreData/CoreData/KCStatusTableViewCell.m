...
//    NSURL *mbTypeUrl=[NSURL URLWithString:status.user.mbtype];
//    [_mbType sd_setImageWithURL:mbTypeUrl ];
    ...
    NSString *dateStr=[formater stringFromDate:status.createdAt];
    CGSize createAtSize=[dateStr sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:kStatusTableViewCellCreateAtFontSize]}];
